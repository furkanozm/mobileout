...
import { LogOut, Pencil, Lock, X, Check, ArrowLeft } from "lucide-react"
...
export function Profile({ onNavigate, onLogout, onMenuClick }: ProfileProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-blue-50 relative overflow-hidden">
      <Header
        title={isChangingPassword ? "Şifre Değiştir" : "Profil Bilgileri"}
        onMenuClick={onMenuClick}
        leftContent={
          isChangingPassword ? (
            <Button variant="ghost" size="icon" onClick={handleCancelPasswordChange}>
